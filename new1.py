...
Testing of new or changed functionality
Regression testing
Retesting
Manual testing
Automated testing
...
It is mandatory to consider all the requirements in Nordea Test Strategy. If a requirement can not be applied due to the nature of the application or system and are decided to be out of scope, it is mandatory to provide a valid justification in the IT initiative Master Test Plan.
 ...
 Test process
It is mandatory that all IT initiatives (agile, SAFe and traditional) follow Nordea’s common test process.

In order to achieve transparency and fact-based decisions, it is mandatory that all IT initiatives:

Describe how the Nordea test process is applied and implemented locally in the IT initiative and its relationship with the IT initiative software development lifecycle in the master test plan (MTP)

Preserve knowledge at Nordea and enable test efficiency by documenting the test approaches from which the test cases are derived, in the master test plans and level test plans
...
Implement the test process to enable reporting of Nordea’s mandatory test metrics and KPIs
...
In each test level the following activities must be planned for:

static testing

regression testing

retesting (must be carried out for failed test cases after defect fixes)
...
To decrease cost due to failures.
To ensure seamless behavior to end users during redirection.
...
contexts2 = [str1, str2, str3, str4, str5, str6,str7, str8, str9,str10, str11,str12,str13, str14,str15,str16,str17,str18,str19,str20,str21,str22,str23,str24,str25]
#10 is too long


questions2 = [
    "what are the causes of errors ?",
"Who is Test data management ? ",
    "what is mandatory for Nordea test reports ?",
    " who is responsible for Test Process - Defect Management ?",
    "who is Summary mandatory items	?",
    ...
    "what is the best selling sci-fi book ?",
    "What are goals of non-functional testing ?",
    "how many searches are performed on Google ?",
